...
#include "cimgui/imgui/imgui.h" // for imGui::GetCurrentWindow()
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::MaquinaSencilla()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		static const char* const keywords[] = {
			"mov", "MOV", "CMP", "cmp", "BEQ", "beq", "ADD", "add"
		};
		...
		langDef.mName = "Maquina Sencilla";
